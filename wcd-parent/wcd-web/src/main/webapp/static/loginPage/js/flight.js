...
/***/ function(module, exports, __webpack_require__) {
	...
	var textures = [{
	  file: 'loginPage/img/flight.jpg',
	  name: 'image',
	  align: textureAlign,
	  scale: { x: 1, y: 1 }
	}, {
	  file: 'loginPage/img/flight-mask.jpg',
	  name: 'mask',
	  align: textureAlign,
	  scale: { x: 0.05, y: 0.05 }
	}, {
	  file: 'loginPage/img/flight-depth.jpg',
	  name: 'depth',
	  align: textureAlign,
	  scale: { x: 0.5, y: 0.5 }
	}, {
	  file: 'loginPage/img/noise.png',
	  name: 'noise',
	  repeat: true,
	  fill: false
	}];
	...
	//var contents = [loadContent('loginPage/img/air-travel-title.svg', document.querySelector('.Text-title')), loadContent('loginPage/img/air-travel-title-medium.svg', document.querySelector('.Text-titleMedium'), 0.5), loadContent('loginPage/img/air-travel-title-small.svg', document.querySelector('.Text-titleSmall'), 0.8)];
